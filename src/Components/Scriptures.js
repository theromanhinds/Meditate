...
export const BooksChaptersVerses = {
  Genesis: {
    chapters: 50,
    verses: [31, 25, 24, 26, 32, 22, 29, 22, 28, 32, 27, 20, 28, 24, 21, 30, 27, 22, 24, 18, 32, 29, 30, 29, 34, 34, 33, 25, 38, 30, 25, 30, 34, 27, 33, 22, 30, 20, 32, 29, 31, 30, 31, 29, 34, 30, 31, 22, 23, 31],
  },
  Exodus: {
    chapters: 40,
    verses: [22, 25, 22, 31, 23, 30, 29, 32, 35, 29, 30, 30, 25, 38, 27, 36, 30, 27, 25, 38, 29, 30, 34, 32, 38, 35, 31, 36, 29, 40, 30, 43, 23, 35, 40, 31, 39, 34, 32, 38],
  },
  Leviticus: {
    chapters: 27,
  ...
  "2 Chronicles": {
    chapters: 36,
    verses: [17, 18, 17, 22, 14, 42, 22, 18, 31, 19, 23, 16, 23, 14, 19, 14, 19, 34, 11, 37, 20, 12, 21, 27, 28, 23, 9, 27, 36, 27, 21, 33, 25, 33, 27, 23],
  },
  Ezra: {
    chapters: 10,
